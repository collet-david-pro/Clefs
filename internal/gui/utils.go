...
func createAboutView() fyne.CanvasObject {
	...
	featList := container.NewVBox(
		...
		widget.NewLabel("  • Bon de remise PDF généré à chaque emprunt, rééditable à jour en un clic"),
		widget.NewLabel("  • Alerte d'inventaire si plus de clés sont sorties que le stock (sur-prêt signalé, jamais bloqué)"),
